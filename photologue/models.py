...
class PhotoGroup(models.Model):
    ...
    pmcheck1 = models.CharField(_("Facilities don't have any visible damage to affect the safety"), max_length=10,
                                default="")
    pmcheck2 = models.CharField(_("Facilities don't have any obvious rust (including stents)"), max_length=10,
                                default="")
    ...
    pmcheck5 = models.CharField(_("Facilities wiring/cable leakage current or other malfunction"), max_length=10,
                                default="")
    pmcheck6 = models.CharField(_("Facilities case have grounding"), max_length=10, default="")
    pmcheck7 = models.CharField(_("Wiring/Cable don't have any visible damage to affect the safety"), max_length=10,
                                default="")
    pmcheck8 = models.CharField(_("Cleaning up litter and fragmentation surrounding the room"), max_length=10,
                                default="")
    pmcheck9 = models.CharField(_("Lighting switch testing"), max_length=10, default="")
    pmcheck10 = models.CharField(_("The controller don't have any visible damage to affect the safety"), max_length=10,
                                 default="")
    pmcheck11 = models.CharField(_("Ther controller don't have any visible damage to affect the safety"), max_length=10,
                                 default="")
