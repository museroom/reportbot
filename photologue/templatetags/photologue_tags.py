...
@register.filter(name="department_item_list")
def department_item_list( qfilter ):
	print( "filter: department_item_list: {}".format(qfilter))
	return DepartmentItem.objects.all()
